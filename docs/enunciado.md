<!-- Este archivo es el enunciado original del TP publicado por la cátedra.
     Era el README.md de la raíz, heredado del fork de utnfrrodsw/tp, y se movió
     acá para que el README del proyecto pueda cumplir su función: explicar cómo
     instalar y ejecutar Musicboxd. No se modifica su contenido; solo se
     ajustaron los links relativos, que ahora apuntan un nivel más arriba. -->
